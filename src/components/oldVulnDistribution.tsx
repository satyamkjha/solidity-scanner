...
const OldVulnerabilityDistribution: React.FC<IssueSeverityDistribution> = ({
  critical,
  high,
  medium,
  low,
...
export const OldVulnerabilityDistributionFilter: React.FC<{
  critical: number;
  high: number;
  medium: number;
  low: number;
...
export default OldVulnerabilityDistribution;