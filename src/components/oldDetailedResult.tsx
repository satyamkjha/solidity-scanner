...
import { OldMultiFileExplorer } from "./OldResult";

export const OldDetailedResult: React.FC<{
  type: "block" | "project";
    ...
    >
      ...
      >
        {!details_enabled ? (
          ...
          <OldMultiFileExplorer files={files} type={type} />
        ) : (
          <Flex
            sx={{
              w: "100%",
...
export default OldDetailedResult;
