  ...
  return (
    <>
      ...
      <Container maxW="100vw" color="black" >
        <Flex maxW="7xl" mx="auto" flexDirection="column" alignItems="center" py={7} px={4} background="rgba(82, 255, 0, 0.04)" backgroundImage="url(./pattern.png)" borderRadius="xl">
          <Text
            fontSize="4xl"
            fontWeight="700"
            my={1}
          ...
          <Flex flexDirection="row" alignItems="center" mt={7} px={2} py={2} background="#FFFFFF" borderRadius="full" maxW="85vw">
            <ActionButton onClick={() => setTab("weekly")} fontSize="lg" py={1} px={10} borderRadius="full" mr={1} variant={tab === "weekly" ? "brand" : "ghost"}>Weekly</ActionButton>
            <ActionButton onClick={() => setTab("monthly")} fontSize="lg" py={1} px={10} borderRadius="full" mx={1} variant={tab === "monthly" ? "brand" : "ghost"}>Monthly</ActionButton>
            <ActionButton onClick={() => setTab("yearly")} fontSize="lg" py={1} px={10} borderRadius="full" ml={1} variant={tab === "yearly" ? "brand" : "ghost"}>Yearly</ActionButton>
          </Flex>
        </Flex>
        {tab === "weekly" &&
          (
