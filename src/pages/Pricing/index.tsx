            ...
            <ScaleFade initialScale={0.9} in={tab === "weekly"}>
              ...
              >
                ...
                >
                      ...
                      <HStack spacing={1}>
                        ...
                        <VStack spacing={1} align={"left"}>
                          ...
                          <Text
                            ...
                            fontWeight={"300"}
                          >
                            Use allotted credits to scan your solidity source
                            code
                          </Text>
                        </VStack>
                      </HStack>
                      ...
                      <HStack spacing={1}>
                        ...
                        <VStack spacing={1} align={"left"}>
                          ...
                          <Text
                            ...
                            fontWeight={"300"}
                          >
                            Generate Report for the scans that you have
                            completed
                          </Text>
                        </VStack>
                      </HStack>
                              ...
                              <PopoverContent p={5}>
                                ...
                                <PopoverBody>
                                  <Text
                                    ...
                                    mb={4}
                                  >
                                    You can publish a detailed report of the
                                    scan conducted and then share it across your
                                    team or organization using a public URL.
                                  </Text>
                                  <Image src="/carousel/Screenshot 5.png" />
                                </PopoverBody>
                              </PopoverContent>
                  ...
                  >
                    {Object.keys(pricingDetails.pricing_data.monthly).map(
                      (plan) => (
                        <PricingColumn
                          plan={plan}
                          planData={pricingDetails.pricing_data.monthly[plan]}
